...
<?php while (have_posts()): the_post(); ?>
	...
	<?php endif; ?>
					...
					<nav id="image-navigation" class="navigation image-navigation">
						<div class="nav-links">
						<?php previous_image_link(false, '<div class="previous-image">'.__('Previous Image', 'portra').'</div>'); ?>
						<?php next_image_link(false, '<div class="next-image">'.__('Next Image', 'portra').'</div>'); ?>
						</div><!-- .nav-links -->
